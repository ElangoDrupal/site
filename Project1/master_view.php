<?php if (isset($_GET['page']) && $_GET['page'] == 'add_admin') { ?>
        <?php
        $status_e = '';
        $status_s = '';
        if (isset($_POST['admin_edit_id']) && $_POST['admin_edit_id'] != '') {
                if (!isset($_POST['name']) && $_POST['name'] == '' && !isset($_POST['password']) && $_POST['password'] == '') {
                        $status_e = 'Please enter all fields.';
                } else {
                        $sql = "UPDATE admin SET 
                                password='" . $_POST['password'] . "',
                                name='" . $_POST['name'] . "' where id='" . $_POST['admin_edit_id'] . "'";
                        mysql_query($sql);
                        if (mysql_affected_rows() > 0) {
                                $status_s = 'admin has been Updated by master <strong>Successfully</strong>.';
                        } else {
                ...
                $sql = "INSERT INTO `admin` (`name`, `password`, `type`) VALUES ('" . $_POST['username'] . "', '" . $_POST['password'] . "', 'admin')";
                mysql_query($sql);
                if (mysql_affected_rows() > 0) {
                        $status_s = 'Admin has been Added <strong>Successfully</strong>.';
                } else {
                        $status_e = 'Something is wrong. <strong>Please try again</strong>.';
                }
        }
        ?>
        <div class="center-block" style="width:600px;max-width: 100%;margin-top: 15%;">
                <div class="jumbotron">
                ...
                <table class="table table-hover table-bordered table-striped">
                        ...
                        <tbody>
                                ...
                                $admin_id = "IS NULL";
                                $history = '0';
                                $sql = "SELECT * FROM admin where type='admin' ORDER BY name ASC";
                                ...
                                if (mysql_num_rows($result) > 0) {
                                        ...
                                        while ($row = mysql_fetch_assoc($result)) {
                                                ...
                                                <tr>
                                                        ...
                                                        <td><a href="javascript:void(0);" class="btn btn-primary" data-toggle="modal" data-target="#myModal<?php echo $row["id"]; ?>">Edit</a>
                                                                                        ...
                                                                                        <div class="modal-body">
                                                                                                <div class="well">
                                                                                                        <form method="post">
                                                                                                                ...
                                                                                                                <p><b>Password</b> : <input type="text" name="password" placeholder="Email" value="<?php echo $row["password"]; ?>" required/></p>
                                                                                                                <input type="hidden" name="admin_edit_id" value="<?= $row["id"] ?>"/>                                 
                                                                                                                <input type="submit" class="btn btn-primary" id="submit-btn" value="Edit" />
                                                                                                        </form>
                                                                                                </div>
...
<?php } else if (isset($_GET['page']) && $_GET['page'] != '') { ?>
        <?php
        $status_e = '';
        $status_s = '';
        if (isset($_POST['guest_id']) && $_POST['guest_id'] != '') {
                if (!isset($_POST['name']) && $_POST['name'] == '' && !isset($_POST['email']) && $_POST['email'] == '' && !isset($_POST['phone']) && $_POST['phone'] == '' && !isset($_POST['memb_name']) && $_POST['memb_name'] == '' && !isset($_POST['comment']) && $_POST['comment'] == '') {
                        ...
                        mysql_query($sql);
                        if (mysql_affected_rows() > 0) {
                                $status_s = 'User Info has been Updated by master <strong>Successfully</strong>.';
                        } else {
                                $status_e = 'Something is wrong. <strong>Please try again</strong>.';
                        }
                }
                ...
                if (!isset($_POST['acomment']) && $_POST['acomment'] == '') {
                        ...
                        mysql_query($sql);
                        if (mysql_affected_rows() > 0) {
                                $status_s = 'Coomment has been Updated by master <strong>Successfully</strong>.';
                        } else {
                                $status_e = 'Something is wrong. <strong>Please try again</strong>.';
                        }
                }
                ...
                if (!isset($_POST['admin_comment']) && $_POST['admin_comment'] == '' && !isset($_POST['name']) && $_POST['name'] == '') {
                        ...
                        mysql_query($sql);
                        if (mysql_affected_rows() > 0) {
                                $status_s = 'master Comment has been Added <strong>Successfully</strong>.';
                        } else {
                                $status_e = 'Something is wrong. <strong>Please try again</strong>.';
                        }
                }
                                                                                                ...
                                                                                                <div class="modal-body">
                                                                                                        <div class="well">
                                                                                                                <form method="post">
                                                                                                                        ...
                                                                                                                        <input type="submit" class="btn btn-primary" id="submit-btn" value="Update User Info" />
                                                                                                                </form>
                                                                                                        </div>
...
<?php } else { ?>
        <div class="center-block" style="width:600px;max-width: 100%;margin-top: 15%;">
                <div class="jumbotron">
                        <h3 class="text-center">Please select a page from top menu.</h3>
                </div>
        </div>
        <?php
}?>